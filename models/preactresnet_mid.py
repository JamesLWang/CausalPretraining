...
class FDC_deep_preact(nn.Module):
    def __init__(self, z_hidden, sub_in_dim, block=PreActBlock, num_blocks=[2,2,2,2], num_classes=10):
        ...
        # self.conv1 = nn.Conv2d(3, 16, kernel_size=5, stride=2, padding=2, bias=False) # hurt final result, because training accuracy gets to 100 quickly
        # the backbone model learns no features.
...
class VAE_Small(nn.Module):
    def __init__(self):
        ...
        self.fc21 = nn.Conv2d(128, 128, kernel_size=1, stride=1, padding=0, bias=False)
        self.fc22 = nn.Conv2d(128, 128, kernel_size=1, stride=1, padding=0, bias=False)
        # self.fc3 = nn.Linear(z_hidden, hidden_dim)
        # self.fc4 = nn.Linear(hidden_dim, in_dim)
        ...
        self.up3 = nn.UpsamplingNearest2d(scale_factor=2)
        self.pd3 = nn.ReplicationPad2d(1)
        self.d4 = nn.Conv2d(128, 32, 3, 1, padding=1)
        self.d42 = nn.Conv2d(32, 32, 3, 1, padding=1)
        self.bn8 = nn.BatchNorm2d(32, 1.e-3)
        self.bn82 = nn.BatchNorm2d(32, 1.e-3)
